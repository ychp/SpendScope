...
actor GitHubAppReleaseClient: AppReleaseProviding {
    ...
    private let latestReleaseURL = URL(string: "https://github.com/ychp-ai/CodexVista/releases/latest")!
    private let installerName = "CodexVista-macOS-unsigned.dmg"
    ...
    func latestRelease() async throws -> AppRelease {
        ...
        request.setValue("CodexVista", forHTTPHeaderField: "User-Agent")
        ...
        let assetBaseURL = URL(
            string: "https://github.com/ychp-ai/CodexVista/releases/latest/download/"
        )!
        return AppRelease(
            version: version,
            pageURL: pageURL,
    ...
    func downloadInstaller(for release: AppRelease) async throws -> URL {
        ...
        let destination = updatesDirectory.appendingPathComponent(
            "CodexVista-\(release.version.description).dmg",
            isDirectory: false
        )
    ...
    private func updatesDirectoryURL() throws -> URL {
        ...
        let directory = caches
            .appendingPathComponent("CodexVista", isDirectory: true)
...
final class AppUpdateService {
    ...
    func openReleasePage() {
        let url = state.availableRelease?.pageURL
            ?? URL(string: "https://github.com/ychp-ai/CodexVista/releases/latest")!
