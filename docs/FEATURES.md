...
- 皮肤可选择经典或水墨；经典支持跟随系统、浅色和深色，水墨仅支持浅色，看板、状态栏弹窗、设置与项目详情同步生效。外观设置用预览卡选择现有皮肤。选择水墨时色系仅显示浅色，切回经典后恢复此前色系偏好。经典采用铝灰与钴蓝、仪表刻度和 DIN 数字；水墨采用雾白纸纹、淡墨山峦、远舟与苇草、笔触额度条、宋体标题、衬线数字和朱砂选中状态；设置中的当前套餐同步使用纸色底、朱砂细边框与印章式徽标。
- 设置看板是否始终置顶。
